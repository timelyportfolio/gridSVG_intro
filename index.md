...
Here is the slightly modified code that will produce our starting chart.  Now would also be a good time to get the newest gridSVG with `install.packages("gridSVG", repos="http://R-Forge.R-project.org")`.
...
There are lots of ways that we might add a tooltip if that is all we want.  However, I think we will want more than just tooltips, so a full d3-style data bind will be a fine way to achieve this extra functionality.  When we export our graphic,
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="720px" height="288px" viewBox="0 0 720 288" version="1.1">
  <metadata xmlns:gridsvg="http://www.stat.auckland.ac.nz/~paul/R/gridSVG/">
    <gridsvg:generator name="gridSVG" version="1.3-0" time="2013-08-05 14:31:28"/>
        ...
        <g id="GRID.gTableParent.120.1">
          ...
          <g id="layout::panel.3-4-3-4.1" clip-path="url(#layout::panel.3-4-3-4.1.clipPath)">
            <g id="panel.3-4-3-4.1">
              <g id="grill.gTree.84.1">
                <g id="panel.background.rect.75.1">
                ...
                <g id="panel.grid.minor.y.polyline.77.1">
                ...
                <g id="panel.grid.minor.x.polyline.79.1">
                ...
                <g id="panel.grid.major.y.polyline.81.1">
                ...
                <g id="panel.grid.major.x.polyline.83.1">
              ...
              <g id="smooths.gTree.71.1">
                <g id="geom_ribbon.polygon.68.1">
          ...
          <g id="layout::axis-l.3-3-3-3.1">
            <g id="layout::axis-l.3-3-3-3::GRID.VP.6.1">
              <g id="axis-l.3-3-3-3.1">
                <g id="layout::axis-l.3-3-3-3::GRID.VP.6::axis.1">
                  <g id="GRID.gTableParent.125.1">
                    <g id="layout::axis-l.3-3-3-3::GRID.VP.6::axis::axis.1-1-1-1.1">
                      <g id="axis.1-1-1-1.1">
                    ...
                    <g id="layout::axis-l.3-3-3-3::GRID.VP.6::axis::axis.1-2-1-2.1">
                      <g id="axis.1-2-1-2.1">
          ...
          <g id="layout::axis-b.4-4-4-4.1">
            <g id="layout::axis-b.4-4-4-4::GRID.VP.5.1">
              <g id="axis-b.4-4-4-4.1">
                <g id="layout::axis-b.4-4-4-4::GRID.VP.5::axis.1">
                  <g id="GRID.gTableParent.131.1">
                    <g id="layout::axis-b.4-4-4-4::GRID.VP.5::axis::axis.1-1-1-1.1">
                      <g id="axis.1-1-1-1.2">
                    ...
                    <g id="layout::axis-b.4-4-4-4::GRID.VP.5::axis::axis.2-1-2-1.1">
                      <g id="axis.2-1-2-1.1">
                  ...
                  <g id="layout::guide-box.3-5-3-5::guide-box.3-5-3-5::guide-box.3-5-3-5::guides.2-2-2-2.1">
                    <g id="layout::guide-box.3-5-3-5::guide-box.3-5-3-5::guide-box.3-5-3-5::guides.2-2-2-2::guides.2-2-2-2.1">
                      <g id="layout::guide-box.3-5-3-5::guide-box.3-5-3-5::guide-box.3-5-3-5::guides.2-2-2-2::guides.2-2-2-2::guides.2-2-2-2.1">
                        <g id="GRID.gTableChild.144.1">
                          <g id="layout::guide-box.3-5-3-5::guide-box.3-5-3-5::guide-box.3-5-3-5::guides.2-2-2-2::guides.2-2-2-2::guides.2-2-2-2::background.1-6-6-1.1">
                            <g id="background.1-6-6-1.2">
